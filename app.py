...
def is_valid_url(url):
    ...
    try:
        result = urlparse(url)
        # Check if it has scheme and netloc, and netloc contains a dot (for domain)
...
def shorten_url():
    ...
    # First validate the basic format before adding protocol
    ...
    # Use the validated URL with protocol
